resource "google_container_cluster" "tuna_cluster" {
  name     = "tuna-cluster"
  location = var.main_zone # Zonal
...
resource "google_container_node_pool" "app_cluster_linux_node_pool" {
  name           = "${google_container_cluster.tuna_cluster.name}--linux-node-pool"
  location       = google_container_cluster.tuna_cluster.location
  # node_locations = var.node_zones
  cluster        = google_container_cluster.tuna_cluster.name
  node_count     = 1
